...
With a function to test for primality, and the inifinite sequence of integers, it's easy enough to make an infinite list of all the primes like:
...
Whenver I needed, say, the first 100 prime numbers, all I needed to execute was `take 10 primes`.