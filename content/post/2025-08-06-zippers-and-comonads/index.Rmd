...
Then out `cojoin` is simply to make a new zipper with the `left` element being the application of `lefts()` to our input zipper, and `right` being the application of `rights` to our input zipper.
